        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur"
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="font-weight-bolder text-white mb-0">Cadastrar referencia - {{ $user->nome }}</h6>
                </nav>
        ...
        <div style="margin-top: 100px;" >
            ...
            <div class="row mt-3">
                                 <div class="col-md-8 mb-3">
                                   <label class="form-control-label" for="validationCustom02">Referência:</label>
                                   <input type="text" class="form-control" onkeyup="maiuscula(this)" id="validationCustom02"id="referencia" name="referencia" required>
                                 </div>
                                 <div class="col-md-4 mb-3">
                                    <label class="form-control-label" for="validationCustom02">Codigo:</label>
                                    <input type="number" class="form-control" id="validationCustom02" id="codigo" name="codigo" required>
                                  </div>
                ...
                <div class="col-lg-12 mb-2 mb-lg-0">
                    <div class="card z-index-2 h-100">
                        <div class="card-header d-flex align-items-center border-bottom py-3">
                            <h4 class="text-capitalize">Referência cadastradas</h4>
                        </div>
          ...
          <div class="modal-content">
            <div class="modal-body p-0">
              <div class="card card-plain">
                ...
                <div class="card-body">
                    <form class="needs-validation" action="{{ route('referencias.update', ['id' => $li->id]) }}" method="POST" novalidate>
                        @csrf
                        @method('PUT')
                        <div class="card multisteps-form__panel p-3 border-radius-xl bg-white js-active"
                            ...
                            <div class="multisteps-form__content">
                                <div class="row mt-3">
                                    <div class="col-md-8 mb-3">
                                      <label class="form-control-label" for="validationCustom02">Referência:</label>
                                      <input type="text" class="form-control" onkeyup="maiuscula(this)" id="validationCustom02"id="referencia" name="referencia" placeholder="" value="{{$li->referencia}}">
                                    </div>
                                    <div class="col-md-4 mb-3">
                                       <label class="form-control-label" for="validationCustom02">Codigo:</label>
                                       <input type="number" class="form-control" id="validationCustom02" id="codigo" name="codigo" placeholder="" value="{{$li->codigo}}">
                                     </div>
