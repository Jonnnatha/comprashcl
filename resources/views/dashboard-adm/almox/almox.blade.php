        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur"
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="font-weight-bolder text-white mb-0">Cadastrar Almoxarifado - {{ $user->nome }}</h6>
                </nav>
                ...
                <div class="col-lg-12 mb-2 mb-lg-0">
                    <div class="card z-index-2 h-100">
                        <div class="card-header d-flex align-items-center border-bottom py-3">
                            <h4 class="text-capitalize">Almoxarifado cadastrados</h4>
                        </div>
          ...
          <div class="modal-content">
            <div class="modal-body p-0">
              <div class="card card-plain">
                ...
                <div class="card-body">
                    <form class="needs-validation" action="{{ route('almox.update', ['id' => $li->id]) }}" method="POST" novalidate>
                        @csrf
                        @method('PUT')
