                        ...
                        <tbody>
                            ...
                            <tr> <!-- Adiciona a tag <tr> para iniciar uma nova linha da tabela -->
                                <td>
                                    ...
                                    <a class="btn btn-slack btn-icon-only rounded-sm" href="{{ route('solicitacoes.cotacao', $li->id) }}"><i class="fas fa-share"></i></a>
                            ...
                            <tbody>
                                ...
                                <tr> <!-- Adiciona a tag <tr> para iniciar uma nova linha da tabela -->
                                    <td>
                                        ...
                                        <button class="btn btn-warning btn-icon-only rounded-sm" data-bs-toggle="modal" data-bs-target="#modal-default{{$li->id}}"><i class="fas fa-clipboard-check"></i></button>
                                        <a class="btn btn-slack btn-icon-only rounded-sm" href="{{ route('solicitacoes.aprovacao', $li->id) }}"><i class="fas fa-share"></i></a>
                                ...
                                <tbody>
                                    ...
                                    <tr"> <!-- Adiciona a tag <tr> para iniciar uma nova linha da tabela -->
                                        <td>
                                            ...
                                            <button class="btn btn-warning btn-icon-only rounded-sm" data-bs-toggle="modal" data-bs-target="#modal-default{{$li->id}}"><i class="fas fa-clipboard-check"></i></button>
                                            <a class="btn btn-slack btn-icon-only rounded-sm" href="{{ route('solicitacoes.concluida', $li->id) }}"><i class="fas fa-share"></i></a>
