        ...
        <div style="margin-top: 100px;" >
            ...
            <div class="row mt-3">
                                 <div class="col-md-4 mb-3">
                                   ...
                                   <input type="text" class="form-control" id="validationCustom02" name ="nome" placeholder="" value="{{$user->nome}}"readonly>
                                 </div>
                                 <div class="col-md-4 mb-3">
                                    <label class="form-control-label" for="validationCustom02">Cargo:</label>
                                    <input type="text" class="form-control" id="validationCustom02" name ="nome" placeholder="" value="{{$user->cargo}}"readonly>
                                  </div>
                                  <div class="col-md-4 mb-3">
                                    <label class="form-control-label" for="validationCustom02">Função:</label>
                                    <input type="text" class="form-control" id="validationCustom02" name ="nome" placeholder="" value="{{$user->level}}"readonly>
                                  </div>
            </div>
            </div>
            </div>
